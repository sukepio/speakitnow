//
//  RecommendedPhraseRow.swift
//  SpeakItNOW
//
//  Created by 助名直人 on 2026/01/22.
//

import SwiftUI

struct RecommendedPhraseRow: View {
    let phrase : Phrase
    var isSelected : Bool
...
#Preview {
    RecommendedPhraseRow(phrase: MockPhraseData.lowKey, isSelected: true)
}
